import { getDefaultRenderingEngine, RenderOptions } from "./renderers/renderer.js";
...
window.addEventListener("DOMContentLoaded", async () => {
    ...
    fractalExplorer = await FractalExplorer.create({
        ...
        renderingEngine: appState.renderingEngine ?? await getDefaultRenderingEngine(),
...
function updateRendingEngine(renderContext) {
    document.getElementById("flopStats").innerHTML = renderContext.id + (renderContext.options.deep === true ? ".deep" : "");
}
